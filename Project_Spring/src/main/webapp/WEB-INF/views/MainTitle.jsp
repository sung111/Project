...
<body class="mainpage">
    ...
    <div class="tagtitlecontainer">
        ...
        <div class="taglayer">
            ...
            <ul class="taglist">
                <li>
                    <a class="content">사내 복지 제도 개선 안내입니다.</a>
                    <div>
                        <span class="date">2025-01-20</span>
                    </div>
                </li>
                <li>
                    <a class="content">근무 환경 개선을 위한 설문 조사 실시.</a>
                    <div>
                        <span class="date">2025-01-18</span>
                    </div>
                </li>
                <li>
                    <a class="content">신규 복지 프로그램 도입 안내.</a>
                    <div>
                        <span class="date">2025-01-15</span>
                    </div>
                </li>
                <li>
                    <a class="content">사내 교육 프로그램 신청 안내.</a>
                    <div>
        ...
        <div class="taglayer">
            ...
            <ul class="taglist">
                <li>
                    <a class="content">사내 동호회 활동 사진 공유</a>
                    <div>
                        <span class="date">2025-02-02</span>
                    </div>
                </li>
                <li>
                    <a class="content">팀워크 향상을 위한 아이디어 모집</a>
                    <div>
                        <span class="date">2025-02-01</span>
                    </div>
                </li>
                <li>
                    <a class="content">사내 복지 제도에 대한 의견 나누기</a>
                    <div>
                        <span class="date">2025-01-15</span>
                    </div>
                </li>
                <li>
                    <a class="content">겨울 휴가 계획 및 공유</a>
                    <div>
