					...
					<form method="post" action="part_code">
						<div id="mid-contain">
							...
							<div class="mid-contain-article " id="materials_id9">
								...
								<input type="hidden" name="type" value="creat"> <input type="submit" value="생성"
									id="materials_c" class="button"> <input type="button" value="취소" id="matecera_can"
									class="button">
							</div>
						</div>
					</form>
					...
					<form method="post" action="part_code">
						<div id="mid-contain2">
							...
							<div class="mid-contain-article " id="finished_id9">
								...
								<input type="hidden" value="finished_creat" name="type"> <input type="submit" value="생성"
									id="finished_c"> <input type="button" value="취소" id="produc_can" class="button">
							</div>
								...
								<tr class="table_tr">
									<form method="post" action="part_code">
										...
										<td><span class="text_view">${dto.warehouse}</span><input type="text"
												value="${dto.warehouse}" class="text_hide" name="warehouse2"></td>
												...
												<div class="edit_delete_box">
													<div class="edit_delete_box">
														...
														<input type="hidden" name="type" value="update"> <input
															type="submit" value="확인" class="ok"> <input type="button"
									...
									<form method="post" action="part_code">
										...
										<input type="hidden" value="del" name="type"> <input type="hidden"
											value="${dto.materiaid}" name="materiaidValue"> <input type="hidden"
											value="typeValue" name="type"> <input type="submit" value="삭제"
											class="delet user_none">
									</form>
									...
									<form method="post" action="part_code">
										...
										<input type="hidden" value="${dto.materiaid}" name="materiaid">
										<input type="hidden" value="${dto.type}" name="matetype">
										<input type="hidden" value="viewall_del" name="type"> <input type="submit"
											value="삭제" class="total user_none" id="viewall">
									</form>
					</div>
								...
								<tr class="table_tr">
									<form method="post" action="part_code">
										<td><span class="text_view">${dto.productname}</span> <input type="text"
												value="${dto.productname}" class="text_hide" name="productname"> <input
												type="hidden" value="${dto.productname}" name="origin"></td>

										<td><span class="text_view">${dto.partnumber}</span> <input type="text"
												value="${dto.partnumber}" class="text_hide" name="partnumber"></td>

										<td><span class="text_view">${dto.warehouse}</span> <input type="text"
												value="${dto.warehouse}" class="text_hide" name="warehouse"></td>

										<td><span class="text_view">${dto.price}</span><input type="text"
												value="${dto.price}" class="text_hide" name="price"></td>

										<td><span class="text_view">${dto.spec}</span><input type="text"
												value="${dto.spec}" class="text_hide" name="spec"></td>

										<td><span class="text_view">${dto.unit}</span><input type="text"
												value="${dto.unit}" class="text_hide" name="unit"></td>

										<td><span class="text_view">${dto.lotnumber}</span><input type="text"
												value="${dto.lotnumber}" class="text_hide text_width" name="lotnumber">
										</td>
												...
												<div class="edit_delete_box">
													<div class="edit_delete_box">
														<input type="button" value="수정"
															class="update user_none product_up">
									...
									<form method="post" action="part_code">
										...
										<input type="hidden" value="finish_del" name="type"> <input type="hidden"
											value="${dto.productid}" name="materiaidValue"> <input type="submit"
											value="삭제" class="delet user_none">
									</form>
