...
public class Products_DTO {
	...
	String productname;
	String partnumber;
	String expdatedesc; //?ú†?ÜµÍ∏∞Ìïú
	String warehouse;
	String productimage; //?ù¥ÎØ∏Ï?ÎßÅÌÅ¨
	String normalcriteria; // ?†ï?ÉÅ?†ú?íàÍ∏∞Ï?
	String abnormalcriteria; //ÎπÑÏ†ï?ÉÅ?†ú?íàÍ∏∞Ï?
	int price;
	String spec;
	String unit;
	String productdel; //?Ç≠?†ú?ú†Î¨?
	String lotnumber;
