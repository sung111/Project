...
<body>
  ...
  <div class="warrap">
    ...
    <div>
      ...
      <div class="box2">
        ...
        <div class="registration">
          <div class="rightTop">
            ...
            <div><input type="datetime-local" class="date1"></div>
            <button class="btn3">등록</button>
          </div>
          <div>
            <div id="ea">
              생산갯수 : <input type="number" id="myInput" min="1" max="100" oninput="validity.valid||(value='')" value="10"> pack
            </div>
          </div>
      ...
      <div class="box3">
        <div class="box3Top">
          <div><input type="text" class="wp3" placeholder="제품명"></div>
          <div class="date2"><input type="datetime-local" class="indate1"> ~ <input type="datetime-local"
              class="indate2">
          </div>
          <div><button class="btn4">조회</button></div>
        </div>
        <div class="indexBox">
          <div class="index">
            <div>날짜</div>
