...
<form class="login-layer" id="login-layer" action="Login_controller" method="post">
    ...
    <button type="submit" id="login-button">Login</button>
                ...
                <form class="find-layer" id="find-layer">
                    ...
                    <input type="text" name="find_Account_textarea" class="writing_layer find_account"
            ...
            <form class="sublayer">
                <button name="sign-up-button" class="sign-up" id="sign-up-button">Sign Up</button>
                <a name="findid_password-button" class="findid_password" id="findid_password-button">아이디 혹은 비밀번호를 잊으셨나요?</a>
                <button name="sign-up-completed-button" class="sign-up-completed" id="sign-up-completed-button">가입 완료</button>
                <button name="find-account-button" class="find-account" id="find-account-button">인증번호</button>
